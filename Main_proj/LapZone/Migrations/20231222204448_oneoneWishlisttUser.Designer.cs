...
namespace LapZone.Migrations
{
    ...
    [Migration("20231222204448_oneoneWishlisttUser")]
    partial class oneoneWishlisttUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LapZone.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Owner",
                            ImagePath = "Admin",
                            PasswordHash = "80d41c54a8ce6d26ae0bdd509db6b187140cae39b4b771269a0d006b0620e2d2",
                            PhoneNumber = "012",
                            RoleId = 1
                        });
                });
            ...
            modelBuilder.Entity("LapZone.Models.Wishlist", b =>
                {
                    ...
                    b.HasOne("LapZone.Models.User", "User")
                        .WithOne("Wishlist")
                        .HasForeignKey("LapZone.Models.Wishlist", "UserId")
                        .IsRequired()
